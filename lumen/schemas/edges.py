...
LOGICAL_TO_PHYSICAL: dict[tuple[LogicalEdgeType, str, str], str] = {
    ...
    (LogicalEdgeType.BRANCHES_TO, "ObservationNode", "PatternNode"): "branches_to_obs_pat",
    (LogicalEdgeType.BRANCHES_TO, "EventNode", "PatternNode"): "branches_to_evt_pat",
    (LogicalEdgeType.BRANCHES_TO, "SessionNode", "PatternNode"): "branches_to_sess_pat",
    (LogicalEdgeType.BRANCHES_TO, "ObservationNode", "BeliefNode"): "branches_to_obs_bel",
    (LogicalEdgeType.BRANCHES_TO, "EventNode", "BeliefNode"): "branches_to_evt_bel",
    (LogicalEdgeType.BRANCHES_TO, "SessionNode", "BeliefNode"): "branches_to_sess_bel",

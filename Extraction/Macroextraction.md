...
**⚠️ Sensitivity Rule:** Macroextraction reports must **never include or quote** observations with `sensitivity_tier: CRITICAL`. Aggregate statistics derived from CRITICAL observations (e.g., frequency counts, emotional valence averages) may appear only as anonymized numbers — never as text summaries. CRITICAL-tier pattern nodes are excluded from all automatic report surfaces; they appear only when the user explicitly navigates to them.
...
biggest_growth_area:
  ...
  evidence: "Pattern fired 3x this month; EVOLVE decision on 2026-05-11 shows resolution mechanism."
...
motif_of_unprocessed_depth:
  ...
  - pattern_id: pat_mentorship_need
...
biographical_gaps_raised:
  ...
  - gap_id: bgap_001
    ...
    closing_evidence: "Aditya relationship identified as first instance of mentorship."
```

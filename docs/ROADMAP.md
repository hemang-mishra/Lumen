...
Lumen is currently an architecture-stage project. This roadmap defines the build sequence, ordered by dependency and technical risk.
...
1. Implement LLM Abstraction Protocol layer.
2. Set up high-security embedding and LLM providers for `CRITICAL`-tier isolation.
